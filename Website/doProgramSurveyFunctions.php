<?php
	...
	{
		$sql = "INSERT INTO ProgramSurvey (PeopleID, Year, PreferredContact, Website, Biography, DayJob, Expertise, ExpertiseText, Arrival, Departure, MaxPanelsTh, PanelStartTh, PanelEndTh, MaxPanelsFr, PanelStartFr, PanelEndFr, MaxPanelsSa, PanelStartSa, PanelEndSa, MaxPanelsSu, PanelStartSu, PanelEndSu, AvailabilityNotes, Interests, InterestsText, WillingAutograph, WillingReading, WillingYA, WillingKids, ProgramIdeas, ProgramIdeaTitle, ProgramIdeaPanelists, OverdonePrograms, PanelistToAvoid, Accessibility, AdditionalInfo, CanShareInfo, Created) SELECT PeopleID, $year, PreferredContact, Website, Biography, DayJob, Expertise, ExpertiseText, Arrival, Departure, MaxPanelsTh, PanelStartTh, PanelEndTh, MaxPanelsFr, PanelStartFr, PanelEndFr, MaxPanelsSa, PanelStartSa, PanelEndSa, MaxPanelsSu, PanelStartSu, PanelEndSu, AvailabilityNotes, Interests, InterestsText, WillingAutograph, WillingReading, WillingYA, WillingKids, ProgramIdeas, ProgramIdeaTitle, ProgramIdeaPanelists, OverdonePrograms, PanelistToAvoid, Accessibility, AdditionalInfo, CanShareInfo, NOW() FROM ProgramSurvey WHERE PeopleID = " . $_SESSION["PeopleID"] . " ORDER BY Created DESC LIMIT 1";
		$db->query($sql);
	...
	if($task == "Page1")
	{
		...
		if($valid)
		{
			$sql = "UPDATE ProgramSurvey SET Website = '" . $db->real_escape_string($_POST["website"]) . "', Biography = '" .
				...
				$db->real_escape_string($_POST["expertiseText"]) . "', PreferredContact = '$contact' WHERE SurveyID = $surveyID";
			$db->query($sql);
