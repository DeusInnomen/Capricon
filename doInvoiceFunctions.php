<?php
    ...
    else if($task == "ClearMailedFlag") {
        $invoiceIds = $_POST["ids"];
        $db->query("UPDATE Invoice SET Status = 'Sent' WHERE InvoiceID IN ($invoiceIds)");
        echo '{ "success": true, "message": "The invoices have had their Mailed flag cleared." }';
        return;
    }
	else
